        ...
        <div className="row">
          <div className="col col-sm-6">
            <div className="my-3">
              ...
              <input placeholder='Weight(kg)' type="text" value={weight} onChange={(e) => setWeight(e.target.value)} className="form-control" required/>
            </div>
          </div>
          <div className="col col-sm-6">
            <div className="my-3">
              <label className="form-label"></label>
              <input placeholder='Hight(m)' type="text" value={height} onChange={(e) => setHeight(e.target.value)} className="form-control" required/>
            </div>
          </div>
        </div>
